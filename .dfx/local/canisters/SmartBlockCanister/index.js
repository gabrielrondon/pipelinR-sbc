...
import { idlFactory } from './SmartBlockCanister.did.js';
export { idlFactory } from './SmartBlockCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SMARTBLOCKCANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./SmartBlockCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the SmartBlockCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./SmartBlockCanister.did.js")._SERVICE>}
 */
export const SmartBlockCanister = createActor(canisterId);
